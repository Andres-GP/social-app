...
import PostInput from "../app/[locale]/components/PostInput";
...
describe("PostInput component", () => {
  ...
  it("renders textarea and Post button", () => {
    render(<PostInput />);
    expect(screen.getByPlaceholderText("whats_up")).toBeInTheDocument();
    expect(screen.getByText("post")).toBeInTheDocument();
  });

  it("updates textarea on typing", () => {
    render(<PostInput />);
    const textarea = screen.getByPlaceholderText("whats_up") as HTMLTextAreaElement;
